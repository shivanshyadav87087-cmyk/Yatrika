/**
 * Structured & Scalable Pan-India Destinations Dataset
 * Hierarchy: State -> Cities -> Famous Landmarks -> Nearby Hidden Gems
 *
 * Designed for easy expansion: Simply append new States/Cities/Landmarks!
 */

/* Helper to generate normalized facilities schema */
            ...
            hiddenGems: [
              {
                ...
                category: "Coniferous Pine Forest & Eco Trail",
                estCost: "₹900 / person",
                desc: "A serene Himalayan eco-park village surrounded by towering sacred pine trees, offering panoramic views of Mount Kanchenjunga.",
                essentialFacilities: createGemFacilityData({
                  hospName: "Jorebunglow Rural Hospital", hospDist: "8.0 km", hospPhone: "+91 354 2252011",
                  foodName: "Lamahatta Tribal Organic Kitchen", foodType: "Hot Gorkhali Thali & Steamed Momos",
                  stayName: "Pine Trail Gorkha Homestay", stayTariff: "₹1,400/night",
                  policeStationName: "Jorebunglow Police Station", policeStationDist: "8.0 km (10 mins response)", policeStationPhone: "+91 354 2252100", policePatrol: "Hill Patrol PCR Mobile Unit",
                  taxiName: "Lamahatta Taxi Association", taxiPhone: "+91 98320 44112",
                  petrol: "8.0 km", atm: "6.0 km (SBI)", hq: "23 km (Darjeeling)", hw: "4.0 km (Peshok Road)",
                  famousFood: "Darjeeling First Flush Tea, Steamed Thukpa, Momos & Churpi",
                  famousCraft: "Lepcha Handwoven Shawls, Wooden Carved Prayer Wheels & Tibetan Carpets"
                }),
                itinerary: ["07:30 AM: Pine forest canopy walk to sacred hilltop lake", "10:30 AM: Viewpoint photography of Mount Kanchenjunga", "01:00 PM: Hot Gorkhali Thali & fresh Darjeeling tea", "03:30 PM: Visit Takdah heritage tea gardens nearby", "08:00 PM: Cozy stay at Pine Trail Homestay"]
              }
            ]
          }
        ]
            ...
            hiddenGems: [
              {
                ...
                vibeTag: "Heritage & Crafts",
                location: "Hooghly / Chandannagar, West Bengal",
                lat: 26.8667,
                lng: 88.3667,
                distance: "38 km from Kolkata City Hub",
                score: 94,
                womenSafetyIndex: 96,
                uniqueness: 95,
                footfall: "Low (10% of Victoria Memorial)",
                category: "French Colonial Architecture & Promenade",
                estCost: "₹850 / person",
                desc: "A charming former French colony along the Hooghly River featuring French colonial mansions, Strand river promenade, and heritage churches.",
                essentialFacilities: createGemFacilityData({
                  hospName: "Chandannagar Sub-Divisional Hospital", hospDist: "2.0 km", hospPhone: "+91 33 26835011",
                  foodName: "Strand Promenade French Bakery & Cafe", foodType: "Bengali Sweets & Fresh Bakery",
                  stayName: "French Quarter Heritage Villa", stayTariff: "₹1,500/night",
                  policeStationName: "Chandannagar Police Station", policeStationDist: "1.5 km (3 mins response)", policeStationPhone: "+91 33 26835100", policePatrol: "Chandannagar Police PCR Patrol",
                  taxiName: "Chandannagar Toto & Taxi Guild", taxiPhone: "+91 98301 22119",
                  petrol: "1.0 km", atm: "500m (SBI)", hq: "38 km (Kolkata)", hw: "3.0 km (GT Road)",
                  famousFood: "Chandannagar Jalbhara Sandesh, Kosha Mangsho & Mishti Doi",
                  famousCraft: "French Lace Handkerchiefs, Terracotta Clay Dolls & Kantha Stitch Sarees"
                }),
                itinerary: ["08:00 AM: Morning walk along French Strand River Promenade", "10:30 AM: Exploration of Institut de Chandernagor French Museum", "01:00 PM: Traditional Bengali lunch with Jalbhara Sandesh", "04:00 PM: Sunset boat ride on Hooghly River", "08:00 PM: Night stay at Heritage Villa"]
              }
            ]
          }
        ]
...
/**
 * Utility: Flattens all hidden gems across all states/cities/landmarks into a single flat array
 */
...
/**
 * Utility: Get cities for a specific state
 */
...
/**
 * Utility: Get famous landmarks for a specific state & city
 */
